...
public class CustomUserInfoMapper extends AbstractOIDCProtocolMapper implements UserInfoTokenMapper {

    private static final String PROVIDER_ID = "training-oidc-userinfo-mapper";
    ...
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, KeycloakSession session, ClientSessionContext clientSessionCtx) {
        ...
        // check if it is really a user info request
        ...
        if (userInfoEndpointRequest) {
            ...
            token.getOtherClaims().put("custom-userdata",
